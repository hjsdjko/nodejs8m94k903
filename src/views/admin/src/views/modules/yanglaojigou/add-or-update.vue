	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="机构规模" prop="jigouguimo">
					<el-input v-model="ruleForm.jigouguimo" placeholder="机构规模" clearable  :readonly="ro.jigouguimo"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="机构规模" prop="jigouguimo">
					<el-input v-model="ruleForm.jigouguimo" placeholder="机构规模" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="创立时间" prop="chuanglishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.chuanglishijian" label="创立时间" prop="chuanglishijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="机构介绍" prop="jigoujieshao">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.jigoujieshao" label="机构介绍" prop="jigoujieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jigoujieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jigouguimo'){
							this.ruleForm.jigouguimo = obj[o];
							this.ro.jigouguimo = true;
							continue;
						}
						...
						if(o=='jigoujieshao'){
							this.ruleForm.jigoujieshao = obj[o];
							this.ro.jigoujieshao = true;
							continue;
						}
						if(o=='jigoutupian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jigoujieshao = this.ruleForm.jigoujieshao.replace(reg,'../../../nodejs8m94k903/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `yanglaojigou/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.yanglaojigouCrossAddOrUpdateFlag = false;
											this.parent.search();
