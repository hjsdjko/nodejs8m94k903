	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="入住评星" prop="ruzhupingxing">
					<el-select :disabled="ro.ruzhupingxing" v-model="ruleForm.ruzhupingxing" placeholder="请选择入住评星" >
						<el-option
							v-for="(item,index) in ruzhupingxingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="入住评星" prop="ruzhupingxing">
					<el-input v-model="ruleForm.ruzhupingxing"
						placeholder="入住评星" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="入住评价" prop="ruzhupingjia">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="入住评价"
					  v-model="ruleForm.ruzhupingjia" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.ruzhupingjia" label="入住评价" prop="ruzhupingjia">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.ruzhupingjia}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='ruzhupingxing'){
							this.ruleForm.ruzhupingxing = obj[o];
							this.ro.ruzhupingxing = true;
							continue;
						}
						if(o=='ruzhupingjia'){
							this.ruleForm.ruzhupingjia = obj[o];
							this.ro.ruzhupingjia = true;
							continue;
						}
						if(o=='yonghuzhanghao'){
            ...
            this.ruzhupingxingOptions = "★★★★★,★★★★,★★★,★★,★".split(',')
