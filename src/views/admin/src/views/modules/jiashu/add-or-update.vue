	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="家属电话" prop="jiashudianhua">
					<el-input v-model="ruleForm.jiashudianhua" placeholder="家属电话" clearable  :readonly="ro.jiashudianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="家属电话" prop="jiashudianhua">
					<el-input v-model="ruleForm.jiashudianhua" placeholder="家属电话" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'" label="用户账号" prop="yonghuzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.yonghuzhanghao" label="用户账号" prop="yonghuzhanghao">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				jiashuzhanghao: [
					{ required: true, message: '家属账号不能为空', trigger: 'blur' },
				],
				mima: [
				...
				jiashudianhua: [
					{ required: true, message: '家属电话不能为空', trigger: 'blur' },
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiashudianhua'){
							this.ruleForm.jiashudianhua = obj[o];
							this.ro.jiashudianhua = true;
							continue;
						}
						if(o=='jiatingzhuzhi'){
