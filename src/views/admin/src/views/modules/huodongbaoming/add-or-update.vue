	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="报名人数" prop="kebaorenshu">
					<el-select :disabled="ro.kebaorenshu" v-model="ruleForm.kebaorenshu" placeholder="请选择报名人数" >
						<el-option
							v-for="(item,index) in kebaorenshuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="报名人数" prop="kebaorenshu">
					<el-input v-model="ruleForm.kebaorenshu"
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.kebaorenshu = 0
				this.ro.kebaorenshu = false;
			}
            ...
            this.kebaorenshuOptions = "1".split(',')
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
		  if(!this.ruleForm.kebaorenshu){
			  this.$message.error("报名人数不能为空");
			  return
		  }
	      objcross.kebaorenshu = objcross.kebaorenshu - this.ruleForm.kebaorenshu
	      if(objcross.kebaorenshu<0){
