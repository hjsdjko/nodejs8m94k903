	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="床位号" prop="chuangweihao">
					<el-input v-model="ruleForm.chuangweihao" placeholder="床位号" clearable  :readonly="ro.chuangweihao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="床位号" prop="chuangweihao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="价格/天" prop="jiage">
					<el-input v-model.number="ruleForm.jiage" placeholder="价格/天" clearable  :readonly="ro.jiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="价格/天" prop="jiage">
					<el-input v-model="ruleForm.jiage" placeholder="价格/天" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="天数" prop="tianshu">
					<el-input v-model.number="ruleForm.tianshu" placeholder="天数" clearable  :readonly="ro.tianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="天数" prop="tianshu">
					<el-input v-model="ruleForm.tianshu" placeholder="天数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="总价" prop="zongjia">
					<el-input v-model="zongjia" placeholder="总价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.zongjia" label="总价" prop="zongjia">
					<el-input v-model="ruleForm.zongjia" placeholder="总价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="入住时间" prop="ruzhushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.ruzhushijian" label="入住时间" prop="ruzhushijian">
					<el-input v-model="ruleForm.ruzhushijian" placeholder="入住时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="呼叫电话" prop="hujiaodianhua">
					<el-input v-model="ruleForm.hujiaodianhua" placeholder="呼叫电话" clearable  :readonly="ro.hujiaodianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="呼叫电话" prop="hujiaodianhua">
					<el-input v-model="ruleForm.hujiaodianhua" placeholder="呼叫电话" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="预订备注" prop="yudingbeizhu">
					<el-input v-model="ruleForm.yudingbeizhu" placeholder="预订备注" clearable  :readonly="ro.yudingbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="预订备注" prop="yudingbeizhu">
					<el-input v-model="ruleForm.yudingbeizhu" placeholder="预订备注" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='hujiaodianhua'){
							this.ruleForm.hujiaodianhua = obj[o];
							this.ro.hujiaodianhua = true;
							continue;
						}
						if(o=='yudingbeizhu'){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `chuangweiyuding/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.chuangweiyudingCrossAddOrUpdateFlag = false;
											this.parent.search();
